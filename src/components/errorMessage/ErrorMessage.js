        ...
        <div className="loading-error">
            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512">
                ...
                <g transform="rotate(45 256 256)">
                    <path d="M304,355a24,24,0,0,1-48,0V133" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="12" stroke="url(#c)"/>
                    <g transform="rotate(180 256 175)">
                        <path d="M376,237c0-53-53.73-96-120-96s-120,43-120,96l12.74-5.85c17.9-8.23,40.88-8,58.49.52l11,5.33,6.81-3.5c18.53-9.51,43.41-9.51,61.94,0l6.81,3.5,11-5.33c17.61-8.54,40.59-8.75,58.49-.52Z" stroke="#ef4444" stroke-miterlimit="10" stroke-width="4" fill="url(#d)"/>
            ...
            <div className="error-message">Something is wrong...</div>
        </div>
    );
}
